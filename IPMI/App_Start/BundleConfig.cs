...
namespace IPMI
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            string account = "~/Scripts/Account/";
            string ltejs = "/Scripts/adminlte/js/";
            ...
            bundles.Add(new ScriptBundle("~/bundles/lib")
                ...
                //add by Haris
                .Include(account + "Login.js"));
            // plugins | datatables
            bundles.Add(new ScriptBundle("~/Scripts/adminlte/components/js").Include(
                                         "~/Scripts/adminlte/components/datatables.net/js/jquery.dataTables.min.js",
                                         "~/Scripts/adminlte/components/datatables.net-bs/js/dataTables.bootstrap.min.js"));

            bundles.Add(new StyleBundle("~/Scripts/adminlte/components/css").Include(
                                        "~/Scripts/adminlte/components/datatables.net-bs/css/dataTables.bootstrap.min.css"));
